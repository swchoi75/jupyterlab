...
lc <- read_race("LC", "data/RACE/(Plan) Analysis FS Item Hierarchy for CU 698_LC.xlsx")
gc <- read_race("GC", "data/RACE/(Plan) Analysis FS Item Hierarchy for CU 698_GC.xlsx")
...
# Write a CSV file ----
write_csv(pl, "output/(Plan) RACE Profit and Loss.csv", na = "0")
write_csv(bs, "output/(Plan) RACE Balance sheet.csv", na = "0")
